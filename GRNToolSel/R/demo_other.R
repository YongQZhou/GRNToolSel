...
#' @param algorithm The algorithm of inferring grn. We provide 16 algorithms in this function including 'Pearson','Spearman','Kendall','WGCNA','BC3NET',
#' 'C3NET','ARACNE.a','ARACNE.m','CLR','MRNET','MRNETB','GeneNet','GENIE3.ET','GENIE3.RF','ENNET,'PCIT'. Default: Pearson.
